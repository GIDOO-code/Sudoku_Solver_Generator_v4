...
namespace GNPXcore{
    ...
    public partial class LatinSquareGen{
        ...
        public void GeneratePara(ref int[,] pSol99,int s1=0,int s2=0){
            ...
            _LatinSquareSub_00();    // block 1

            _LatinSquareSub_01();    // block 2,3, row 1
            _LatinSquareSub_02();    // block 2,3, row 2,3
            
            _LatinSquareSub_11();    // block 4,7, column 1
            _LatinSquareSub_12();    // block 4,7, column 2,3
        ...
        private void _LatinSquareSub_11( ){     // block 4,7, column 1
            int c=0;
            int px=PLft[0]%10;
        ...
        private void _LatinSquareSub_12( ){      // block 4,7, column 2,3
            int nn,rr=0,rs=0;
            int px=PLft[0]%10;
            int rA=(PLft[0]<10)? 0: 3;
            int rB=3-rA;
