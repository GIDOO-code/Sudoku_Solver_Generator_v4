...
namespace GNPXcore{
    ...
    public class GNPX_AnalyzerMan{
      ...
      //  static public event SDKSolutionEventHandler Send_Solved;  20230307
        ...
        private int          stageNo => GPMan.stageNo;     
        public UPuzzleMan    GPMan => pGNPX_Eng.GPMan;

        public UPuzzle       pGP => GPMan.pGP;
        public List<UCell>   pBDL=> pGP.BDL;
        public bool          improper{ get=>pGP.improper; set=>pGP.improper=value; } 




        public int          SolCode{ set =>pGP.SolCode=value; }
...
//==========================================================
        ...
        public bool SnapSaveGP( UPuzzle GPX0 ){
        ...
        public bool Verify_SUDOKU_Roule( ){
            ...
            for(int h=0; h<27; h++){
                int usedB=0, errB=0;
                foreach(var P in pBDL.IEGetCellInHouse(h).Where(Q=>Q.No!=0)){
                    int no = Abs(P.No);
