...
namespace GNPXcore{
    public partial class GroupedLinkGen: AnalyzerBaseV2{
        ...
        // GroupedNiceLoopEx
        // https://gidoo-code.github.io/Sudoku_Solver_Generator/page55.html
        ...
        public bool GroupedNiceLoopEx( ){
			...
			foreach( var P0 in pBDL.Where(p=>(p.FreeB>0)) ){                        // Stem Cell
        ...
        private string _sol_Truth_Message(){
            ...
            foreach( var P in pBDL.Where(p=>p.FixedNo>0) ){
                int noT = P.FixedNo-1;
