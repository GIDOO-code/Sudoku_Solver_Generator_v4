        ...
        private bool _UVWXYZwing( int wsz ){     //simple UVWXYZwing
            ...
            foreach( var P0 in FBCX ){  //focused Cell
                ...
                foreach( int no in P0.FreeB.IEGet_BtoNo() ){ //focused Digit
                    ...
                    int noB=1<<no;
                    Bit81 B81_P0_conn = (new Bit81(pBDL,noB,FreeBC:2)) & ConnectedCells[P0.rc];
                    ...
                    for(int dir=0; dir<2; dir++ ){ //dir 0:row 1:col
                        ...
                        int FreeBin  = B81P0H2.AggregateFreeB(pBDL);
                        ...
                        if( SolInfoB ){
                            ...
                            foreach( var P in B81P0H2.IEGet_rc().Select(p=>pBDL[p]) ) P.Set_CellColorBkgColor_noBit(P.FreeB,AttCr,SolBkCr);
                            foreach( var P in Pout.IEGet_rc().Select(p=>pBDL[p]) ) P.Set_CellColorBkgColor_noBit(P.FreeB,AttCr,SolBkCr);
