...
//      public int          UGLSize{ get{ return UGCellsA.Size+UGCellsB.Size; } }
		...
		public bool			rootF; 
        public int          type;
        public int          h=-1;         //house number(-1:in-cell Link)
        ...
        public GroupedLink( UGrCells UGCellsA, UGrCells UGCellsB, int h, int type ): this(){
            this.UGCellsA = UGCellsA; this.UGCellsB = UGCellsB; //this.h=h;
            this.type=type;
        ...
        public GroupedLink( UCellLink LK ): this(){
            UCelLK=LK;
            UGCellsA=new UGrCells(LK.h,LK.no,LK.UCe1);
            UGCellsB=new UGrCells(LK.h,LK.no,LK.UCe2);
            this.type=LK.type;
            this.h =LK.h;
		...
		public bool EqualNull(){ return (h==-1); }
        ...
        public override string ToString(){
            try{
                string st= $"h:{h.ToString().PadLeft(2)} no:{no} type:{type} ";
        ...
        public string GrLKToString(){
            try{
                ...
                if( this is ALSLink ){
                    ...
                    string st2="";
                    A.ALSbase.UCellLst.ForEach( p =>{  st2 += " r"+(p.r+1) + "c"+((p.c)+1); } );
                    st += "(ALS:"+st2.ToString_SameHouseComp()+") ";
                }
